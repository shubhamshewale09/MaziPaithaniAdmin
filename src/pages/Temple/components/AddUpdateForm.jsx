...
import { GetDistrictLookupList, GetStateLookupList } from "../../../services/List/AllLookupList";
import { AddUpdateUser } from "../../../services/User/UserApi";
...
const AddUpdateForm = ({ onClose, modelRequestData }) => {
    ...
    const GetModelData = async (KeyID) => {
        const data = await GetTempleModel(KeyID);
        if (data.statusCode === 200) {
