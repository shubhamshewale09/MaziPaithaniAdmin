...
const ListComponent = () => {
    ...
    const handleUpdateStatus = async () => {
        if (modelAction === "Status") {
            try {
                let data = await ChangeTempleStatus(modelRequestData.templeKeyID);
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Temple Name", "Temple Time", "Status", "Action"].map((h) => (
                                <th
                                    key={h}
                                        ...
                                        <div className="flex gap-2 justify-center">
                                            ...
                                            <Tooltip title="Add Languagewise">
                                                <button
                                                    className="text-blue-500 hover:text-blue-700"
                                                    onClick={() =>
                                                        navigate("/temple/temple-languagewise", {
                                                            state: { templeKeyID: u.templeKeyID }
                                                        })
                                                    }
                                                >
                                                    <FaLanguage />
