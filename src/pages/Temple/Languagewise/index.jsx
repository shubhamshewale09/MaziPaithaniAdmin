...
import { ChangeTempleStatus, GetTempleList } from "../../../services/Temple/TempleApi";
...
const ListComponent = () => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            setIsLoading(true);
            try {
                const res = await GetTempleList(appliedFilter);
    ...
    const handleUpdateStatus = async () => {
        if (modelAction === "Status") {
            try {
                let data = await ChangeTempleStatus(modelRequestData.templeKeyID, modelRequestData.appLangID);
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Temple Name", "Language", "Temple Time", "Status", "Action"].map((h) => (
                                <th
                                    key={h}
                        ...
                        {isLoading ? (
                            ...
                            tableRows.map((u, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-2 text-gray-700">{u.templeName}</td>
                                    <td className="px-4 py-2 text-gray-700">{u.languageName || "-"}</td>
                                    <td className="px-4 py-2 text-gray-700">{u.templeTimings ? parse(u.templeTimings) : "-"}</td>
            ...
            {/* User Form Modal */}
            {
                modalOpen && (
                    <AddUpdateForm
                        ...
                        keyID={state.templeKeyID} //parent key id for add update
