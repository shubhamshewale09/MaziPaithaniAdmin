...
import { GetAllAlertTypeLookup, GetAllLanguageLookUpList, GetAreaLookupList } from "../../../../services/List/AllLookupList";
...
const AddUpdateForm = ({ onClose, modelRequestData, existingLangIDs }) => {
    ...
    const GetModelData = async (KeyID, appLangID) => {
        const data = await GetAlertModel(KeyID, appLangID);
        if (data.statusCode === 200) {
