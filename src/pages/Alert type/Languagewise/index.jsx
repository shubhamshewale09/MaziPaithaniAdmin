...
import { ChangeAlertTypeStatus, GetAlertTypeList } from "../../../services/Alert type/AlertTypeApi";
...
const ListComponent = () => {
    ...
    const [appliedFilter, setAppliedFilter] = useState({
        ...
        toDate: null,
        userKeyID: userKeyID,
        alertTypeKeyID: state.alertTypeKeyID
    });
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            setIsLoading(true);
            try {
                const res = await GetAlertTypeList(appliedFilter);
    ...
    const handleUpdateStatus = async () => {
        if (modelAction === "Status") {
            try {
                let data = await ChangeAlertTypeStatus(modelRequestData.alertTypeKeyID, modelRequestData.appLangID);
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Alert Type", "Language", "Status", "Action"].map((h) => (
                                <th
                                    key={h}
                                            ...
                                            <Tooltip title="Change Status">
                                                <span
                                                    ...
                                                    onClick={() => {
                                                        setModelRequestData({
                                                            ...modelRequestData,
                                                            alertTypeKeyID: u.alertTypeKeyID,
            ...
            {/* User Form Modal */}
            {
                modalOpen && (
                    <AddUpdateForm
                        ...
                        keyID={state.alertTypeKeyID} //parent key id for add update
