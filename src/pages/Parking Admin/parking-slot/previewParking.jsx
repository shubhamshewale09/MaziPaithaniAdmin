...
import { ChangeParkingStatus, GetParkingList, GetPreviewParkingList } from "../../../services/Parking/ParkingApi";
...
const ListComponent = () => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            setIsLoading(true);
            try {
                const res = await GetPreviewParkingList(appliedFilter);
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Name", "Latitude", "Longitude", "Parking Capacity", "Available Spots", "Parking Manager", "Assigned Staff", "Date"].map((h) => (
                                <th
                                    key={h}
                        ...
                        {isLoading ? (
                            ...
                            tableRows.map((u, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-2 text-gray-700">{u.latitude || "-"}</td>
                                    <td className="px-4 py-2 text-gray-700">{u.longitude}</td>
