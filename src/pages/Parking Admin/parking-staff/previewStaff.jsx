...
import { ChangeUserStatus, GetAssignedStaffPreviewList, GetUserList } from "../../../services/User/UserApi";
...
const ListComponent = () => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            setIsLoading(true);
            try {
                const res = await GetAssignedStaffPreviewList(state?.parkingKeyID);
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Name", "Email", "Mobile No", "Address"].map((h) => (
                                <th
                                    key={h}
