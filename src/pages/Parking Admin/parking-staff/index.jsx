...
const ListComponent = () => {
    ...
    const [appliedFilter, setAppliedFilter] = useState({
        ...
        toDate: null,
        userKeyID: userKeyID,
        moduleName: "ParkingStaff",//pass parking slot
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Name", "Email", "Mobile No", "Role", "Address", "Password", "Assigned Parkings", "Status", "Action"].map((h) => (
                                <th
                                    key={h}
                                    ...
                                    <td className="px-4 py-2">
                                        <button
                                            onClick={() => {
                                                ...
                                                navigate("/users/preview-parkings", {
                                                    state: {
                                                        userID: u.userID,
