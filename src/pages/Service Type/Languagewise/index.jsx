...
const ListComponent = () => {
    ...
    const [appliedFilter, setAppliedFilter] = useState({
        ...
        toDate: null,
        userKeyID: userKeyID,
        serviceTypeKeyID: state.serviceTypeKeyID
    });
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Govt. Service Type", "Language", "Date", "Status", "Action"].map((h) => (
                                <th
                                    key={h}
            ...
            {/* User Form Modal */}
            {
                modalOpen && (
                    <AddUpdateForm
                        ...
                        keyID={state.serviceTypeKeyID} //parent key id for add update
