...
const ListComponent = () => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            setIsLoading(true);
            try {
                const res = await GetVehicleTypeList(appliedFilter);
    ...
    const handleUpdateStatus = async () => {
        if (modelAction === "Status") {
            try {
                let data = await ChangeVehicleTypeStatus(modelRequestData.vehicalTypeKeyID);
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Vehicle Type", "Hourly Charges", "Daily Charges", "Date", "Status", "Action"].map((h) => (
                                <th
                                    key={h}
                        ...
                        {isLoading ? (
                            ...
                            tableRows.map((u, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-2 text-gray-700">{u.hourlyCharges || "-"}</td>
                                    <td className="px-4 py-2 text-gray-700">{u.dailyCharges || "-"}</td>
                                            ...
                                            <Tooltip title="Change Status">
                                                <span
                                                    ...
                                                    onClick={() => {
                                                        setModelRequestData({
                                                            ...modelRequestData,
                                                            vehicalTypeKeyID: u.vehicalTypeKeyID,
