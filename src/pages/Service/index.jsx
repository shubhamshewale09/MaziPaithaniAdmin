...
import { FaCar, FaEdit, FaUser, FaLanguage } from "react-icons/fa";
...
import { ChangeServiceStatus, GetServiceList } from "../../services/Service/ServiceApi";
...
const ListComponent = () => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            setIsLoading(true);
            try {
                const res = await GetServiceList(appliedFilter);
    ...
    const handleUpdateStatus = async () => {
        if (modelAction === "Status") {
            try {
                let data = await ChangeServiceStatus(modelRequestData.serviceKeyID);
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Name", "Mobile", "Service Type", "Address", "Status", "Action"].map((h) => (
                                <th
                                    key={h}
                        ...
                        {isLoading ? (
                            ...
                            tableRows.map((u, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-2 text-gray-700">{u.ownerMoNo || "-"}</td>
                                    <td className="px-4 py-2">{u.serviceType}</td>
                                    ...
                                    <td className="px-4 py-2">
                                        <div className="flex gap-2 justify-center">
                                            ...
                                            <Tooltip title="Add Language-wise">
                                                <button
                                                    className="text-blue-500 hover:text-blue-700"
                                                    onClick={() =>
                                                        navigate("/service-languagewise", {
                                                            state: { serviceKeyID: u.serviceKeyID }
                                                        })
                                                    }
                                                >
                                                    <FaLanguage />
