...
const ListComponent = () => {
    ...
    const [appliedFilter, setAppliedFilter] = useState({
        ...
        toDate: null,
        userKeyID: userKeyID,
        serviceKeyID: state.serviceKeyID
    });
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Service Name","Mobile", "Service Type", "Address", "Language", "Status", "Action"].map((h) => (
                                <th
                                    key={h}
            ...
            {/* User Form Modal */}
            {
                modalOpen && (
                    <AddUpdateForm
                        ...
                        existingLangIDs={tableRows.map(row => row.appLangID)}
                    />
                )
            }
            {/* confirmation modal  */}
