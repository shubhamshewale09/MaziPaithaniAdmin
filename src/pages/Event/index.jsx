...
const ListComponent = () => {
    ...
    const handleUpdateStatus = async () => {
        if (modelAction === "Status") {
            try {
                let data = await ChangeEventStatus(modelRequestData.eventKeyID);
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Title", "Description", "Event Date", "Address", "Event Day", "Status", "Action"].map((h) => (
                                <th
                                    key={h}
                                    ...
                                    <td className="px-4 py-2">
                                        <div className="cursor-pointer flex items-center space-x-2 justify-center">
                                            <Tooltip title="Change Status">
                                                <span
                                                    className={`cursor-pointer text-12 font-medium ${u.status === "True" ? "text-green-600" : "text-red-600"
                                                        }`}
                                                    onClick={() => {
                                                        setModelRequestData({
                                                            ...modelRequestData,
                                        ...
                                        <div className="flex gap-2 justify-center">
                                            ...
                                            <Tooltip title="Add Languagewise">
                                                <button
                                                    className="text-blue-500 hover:text-blue-700"
                                                    onClick={() =>
                                                        navigate("/master/event/languagewise", {
                                                            state: { eventKeyID: u.eventKeyID }
                                                        })
                                                    }
                                                >
                                                    <FaLanguage />
