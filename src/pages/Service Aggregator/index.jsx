...
const ListComponent = () => {
    ...
    const handleUpdateStatus = async () => {
        if (modelAction === "Status") {
            try {
                let data = await ChangeServiceAggregatorStatus(modelRequestData.serviceAggregatorKeyID);
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Name", "Mobile", "Aggregator Type", "Details", "Address", "Status", "Action"].map((h) => (
                                <th
                                    key={h}
                                        ...
                                        <div className="flex gap-2 justify-center">
                                            ...
                                            <Tooltip title="Add Languagewise">
                                                <button
                                                    className="text-blue-500 hover:text-blue-700"
                                                    onClick={() =>
                                                        navigate("/service-aggregator/languagewise", {
                                                            state: { serviceAggregatorKeyID: u.serviceAggregatorKeyID }
                                                        })
                                                    }
                                                >
                                                    <FaLanguage />
