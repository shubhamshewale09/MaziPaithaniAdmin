...
import { FaLocationCrosshairs, FaPeopleLine } from "react-icons/fa6";
...
import { GetGroupMembersList, GetUserVisitedLocations } from "../../../services/Family Group/FamilyGroupApi";
import { useLocation } from "react-router-dom";
import LocationMapDialog2 from "./LocationMapDialog2";
...
const ListComponent = () => {
    ...
    const [appliedFilter, setAppliedFilter] = useState({
        ...
        fromDate: null,
        toDate: null,
        familyGroupKeyID: state?.familyGroupKeyID,
        userKeyID: userKeyID,
    });
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            setIsLoading(true);
            try {
                const res = await GetGroupMembersList(appliedFilter);
    ...
    const handleUpdateStatus = async () => {
        if (modelAction === "Status") {
            try {
                let data = await ChangeStateStatus(modelRequestData.fmKeyID);
        ...
        <div className="bg-background h-full flex flex-col rounded-xl border border-gray-200 shadow">
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Name", "Mobile No", "Location"].map((h) => (
                                <th
                                    key={h}
                        ...
                        {isLoading ? (
                            ...
                            tableRows.map((u, idx) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-2 text-gray-700">{u.memberName}</td>
            ...
            {mapOpen && (
                <LocationMapDialog2
                    ...
                    locations={locations}
                    userKeyID={selectedUser?.userKeyID}
