...
const UserForm = ({ user, onClose, modelRequestData }) => {
        ...
        const fetchLookupData = async () => {
            try {
                const [
                    ...
                    GetRoleTypeLookupList('SuperAdmin'),
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const data = await AddUpdateUser({ ...formData, userKeyID });
            ...
            <div className="bg-white rounded-2xl flex flex-col shadow-lg text-gray-700 text-base w-full sm:w-96 md:w-[500px] lg:w-[600px] xl:w-[700px] max-h-[90vh]">
                ...
                >
                    ...
                    {/* <div>
                        ...
                        <Select
                            className="w-full"
                            options={lookupList?.roleTypeLookupList}
                            onChange={(val) => {
                                setFormData(prev => ({
                                    ...prev,
                                    roleID: val?.value || null,
                                }));
                            ...
                            value={
                                lookupList?.roleTypeLookupList?.find(
                    ...
                    <div>
                        ...
                        <Select
                            //isMulti
                            className={`{w-full ${errors.roleID ? "border-red-500 focus:ring-red-500" : "focus:ring-secondary"}`}
                            options={lookupList?.roleTypeLookupList}
                            onChange={(selectedOptions) => {
                                setFormData(prev => ({
                                    ...prev,
                                    roleID: selectedOptions?.value
                                }));
                            ...
                            value={lookupList?.roleTypeLookupList?.filter((item) => item.value === formData.roleID)}
