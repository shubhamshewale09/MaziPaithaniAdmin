...
const ListComponent = () => {
    ...
    const [appliedFilter, setAppliedFilter] = useState({
        ...
        toDate: null,
        userKeyID: userKeyID,
        amenityKeyID: state.amenityKeyID
    });
    ...
    const handleUpdateStatus = async () => {
        if (modelAction === "Status") {
            try {
                let data = await ChangeAmenityStatus(modelRequestData.amenityKeyID, modelRequestData.appLangID);
            ...
            <div className="flex-1 overflow-auto">
                <table className="min-w-full text-sm text-gray-800 border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                            {["Sr. No.", "Icon", "Name", "Language", "Date", "Status", "Action"].map((h) => (
                                <th
                                    key={h}
            ...
            {/* User Form Modal */}
            {
                modalOpen && (
                    <AddUpdateForm
                        ...
                        keyID={state.amenityKeyID} //parent key id for add update
