        ...
        <div className='relative flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between'>
          <div className='max-w-2xl'>
            ...
            <p className='mt-4 max-w-xl text-sm leading-7 text-[#6c5b54] sm:text-base'>
              Keep an eye on buyers, sellers, orders, and marketplace growth
              from a responsive workspace designed for quick actions.
            </p>
          </div>
      ...
      <section className='grid grid-cols-1 gap-6 xl:grid-cols-[1.4fr_0.9fr]'>
        <div className='dashboard-fade-up rounded-[28px] border border-white/70 bg-white/90 p-6 shadow-[0_20px_60px_rgba(94,35,23,0.08)] sm:p-8'>
          <div className='flex items-center justify-between gap-3'>
            <div>
              ...
              <h2 className='mt-2 text-2xl font-bold text-[#3d1e17]'>
        ...
        <div className='dashboard-fade-up rounded-[28px] border border-white/70 bg-white/90 p-6 shadow-[0_20px_60px_rgba(94,35,23,0.08)] sm:p-8'>
          <div className='flex items-center justify-between'>
            ...
            <Clock3
              size={18}
              className='dashboard-animated-icon text-[#a57b4f]'
            />
          </div>
          ...
          <div className='mt-6 space-y-3'>
            {recentActivity.map((activity, index) => (
              ...
              >
                ...
                <div>
                  <p className='text-sm font-semibold text-[#3d1e17] sm:text-base'>
                    {activity.title}
                  </p>
  ...
  >
    <div className='flex items-start justify-between gap-4'>
      <div>
        ...
        <p className='mt-3 text-2xl font-bold text-[#2f1d18] sm:text-[1.9rem]'>
          {value}
        </p>
      </div>
      <div
        className={`dashboard-icon-shell flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${accent} text-white shadow-lg`}
      >
        <span className='dashboard-icon-glyph'>{icon}</span>
      </div>
    </div>
    <div className='mt-5 flex items-center justify-between'>
      <p className='text-xs font-semibold uppercase tracking-[0.2em] text-[#b08b6d]'>
        Overview
      </p>
...
const MiniMetric = ({ label, value }) => (
  <div className='rounded-2xl border border-white/60 bg-white/75 px-4 py-4 shadow-sm backdrop-blur-sm'>
    <p className='text-[11px] font-semibold uppercase tracking-[0.22em] text-[#a67d65]'>
      {label}
    </p>
