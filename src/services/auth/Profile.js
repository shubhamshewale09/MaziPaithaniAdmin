...
export const GetProfile = async (userId) => {
  console.log(
    'GetProfile API URL:',
    `${Base_Url}api/savedata/GetSeller/${userId}`,
  );
...
export const SaveShopInfo = async (params) => {
  const res = await postApiWithAuthorization(
    `${Base_Url}api/savedata/SaveSeller`,
    params,
  );
  return res;
};

// Update shop info - specific API call for updating existing seller info
...
export const SaveBankDetails = async (params) => {
  const res = await postApiWithAuthorization(
    `${Base_Url}api/savedata/Savesellerbankdeatils`,
    params,
  );
  return res;
};

// Update bank details - specific API call for updating existing bank details
export const UpdateBankDetails = async (params) => {
  const res = await postApiWithAuthorization(
    `${Base_Url}api/savedata/Savesellerbankdeatils`,
    params,
  );
...
export const GetSellerDashboard = async (userId) => {
  const res = await getApiWithAuthorization(
    `${Base_Url}api/dashboard/GetSellerDashboard?RequestedFor=1&TaskId=1&UserId=${userId}`,
  );
  return res;
};
